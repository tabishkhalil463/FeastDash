    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Customer'), ('restaurant_owner', 'Restaurant Owner'), ('delivery_driver', 'Delivery Driver'), ('admin', 'Admin')], default='customer', max_length=20)),
        ...
        migrations.AddIndex(
            model_name='customuser',
            index=models.Index(fields=['city'], name='accounts_cu_city_dc9428_idx'),
        ),
    ]
